    ...
    <br>
        ...
        <div class="container">
            <div class="row justify-content-md-center">
                <div class="col-lg-5">
                    <form style="border: none;" class="text-center border border-light" action="<%=request.getContextPath()%>/resourcesbysubject" method="post">
                        <c:forEach var="resource" items="${resourcesbysubject}" varStatus="theCount">
                            <ul class="list-group">
                                <li class="list-group-item active"><h4>${resource.key}</h4></li>
